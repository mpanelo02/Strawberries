...
const whatAreYouPage=document.getElementById('whatAreYou');
const digitalTwinGuestPage=document.getElementById('digitalTwinGuest')
...
goBackButton.addEventListener('click',function(){
    ...
    whatAreYouPage.style.display="block";
    digitalTwinGuestPage.style.display="none";
    digitalTwinAdminPage.style.display="none";
})
adminButton.addEventListener('click', function(){
    verificationPage.style.display="block";
    whatAreYouPage.style.display="none";
    digitalTwinGuestPage.style.display="none";
    digitalTwinAdminPage.style.display="none";
})
guestButton.addEventListener('click', function(){
    verificationPage.style.display="none";
    whatAreYouPage.style.display="none";
    digitalTwinGuestPage.style.display="block";
    digitalTwinAdminPage.style.display="none";
})
